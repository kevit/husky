 ...
 *****************************************************************************
 * $Id: common.c,v 1.39 2015/08/28 19:03:39 dukelsky Exp $
 */
...
void freeLink (s_link *link)
{
  ...
  if (link->areafix.pwd != link->defaultPwd) nfree(link->areafix.pwd);
  if (link->filefix.pwd != link->defaultPwd) nfree(link->filefix.pwd);
